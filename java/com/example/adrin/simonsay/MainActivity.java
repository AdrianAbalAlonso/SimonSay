package com.example.adrin.simonsay;
...
public class MainActivity extends AppCompatActivity {
    ...
    int[] botones = {R.id.buttonBlue, R.id.buttonRed, R.id.buttonYellow, R.id.buttonGreen};
    String[] colorBoton = {"#00B0FF", "#E57373", "#FFFF99", "#8BC34A"};
    int[] colorClaro = {Color.BLUE, Color.RED, Color.parseColor("#FFFF00"), Color.GREEN};
    int[] Audio = {R.raw.sonido0, R.raw.sonido1, R.raw.sonido2, R.raw.sonido3};//sin embargo desisto con lo de los sonidos , no me funcionan , me da errores de extensión
